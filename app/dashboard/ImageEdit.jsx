...
try {
  const response = await fetch(`https://early-flowers-shave.loca.lt/user/profile-picture`,{
    method:'POST',
    credentials:'include',
    body:formData
  })
...
const deleteImage = async ()=>{
  ...
  setLoading(true)
  try {
    const response = await fetch(`https://early-flowers-shave.loca.lt/user/delete-picture/${userId}`,{
      method:'DELETE',
      credentials:'include',
    })
    if(response.ok){
